...
class MCAPI{
    ...
    {
        $message .= '<br /><br />' . sprintf( '<a href="%s">' . esc_html__( 'Read more about common connectivity issues.', 'urus' ) . '</a>', 'https://kb.mc4wp.com/solving-connectivity-issues/#utm_source=wp-plugin&utm_medium=mailchimp-for-wp&utm_campaign=settings-notice' );
    ...
    private function get_headers()
    {
        ...
        $headers = array(
            ...
            'User-Agent' => 'OVIC/' . $wp_version . '; WordPress/' . $wp_version . '; ' .get_home_url('/'),
        );
    ...
    public function get_reposive_message(){
        return $this->error_message;
    }
}