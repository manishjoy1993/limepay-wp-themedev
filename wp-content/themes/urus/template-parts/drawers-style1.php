...
<div id="Familab_MobileMenu" class="nav-drawer drawer style1">
    ...
    <div class="tab-content mobile-nav-content">
        ...
        <?php endif; ?>
        <div class="tab-pane <?php if(!has_nav_menu('mobile_menu')):?>active<?php endif;?>" id="customerLogin" role="tabpanel">
...
<div id="Familab_SearchDrawer" class="search-drawer drawer style1">
    ...
    <div class="drawer-search-top">
        <?php if ($search_sku) {
            ?>
            <h3 class="drawer-search-title"><?php  esc_html_e('Type the keyword or SKU','urus') ?></h3>
            <?php
        }else{
            ?>
            <h3 class="drawer-search-title"><?php  esc_html_e('Type the keyword and hit enter','urus') ?></h3>
            <?php
        } ?>
    ...
    <form id="familab-search-mobile" data-current-action=""  data-search-sku="<?php echo esc_attr(( $search_sku == true ) ?'true':'false'); ?>" data-form-submit="<?php echo esc_attr(( $search_redirect == true ) ?'true':'false'); ?>" role="search" method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>">
        ...
        <div class="search-drawer-header">
            <div class="drawer_input">
                ...
                <input type="search" name="s" placeholder="<?php esc_attr_e('Search anything','urus');?>" data-last-search-field="">
                <?php
                if ($use_clear_button) {
                ?>
