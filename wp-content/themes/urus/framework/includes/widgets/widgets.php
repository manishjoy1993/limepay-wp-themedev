<?php
if( !class_exists('Urus_Widgets')){
    class Urus_Widgets extends WP_Widget{
        /**
         * CSS class.
         *
         * @var string
        ...
        public function widget_start( $args, $instance ) {
            ...
            ?>
            <div class="widget-content scrollbar-inner">
            <?php
        }
        ...
        public function update( $new_instance, $old_instance ) {
            ...
            foreach ( $this->settings as $key => $setting ) {
                 ...
                 */
                $instance[ $key ] = apply_filters( 'urus_widget_settings_sanitize_option', $instance[ $key ], $new_instance, $key, $setting );
            }
            ...
            foreach ( $this->settings as $key => $setting ) {
                ...
                switch ( $setting['type'] ) {
                    case 'text':
                        ?>
                        <p>
                            <label for="<?php echo esc_attr( $this->get_field_id( $key ) ); ?>"><?php echo esc_html($setting['label']); ?></label><?php // phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped ?>
                    ...
                    default:
                        do_action( 'urus_widget_field_' . $setting['type'], $key, $value, $setting, $instance );
                        break;
                }
            }
        }
        ...
        protected function get_widget_id_for_cache( $widget_id, $scheme = '' ) {
            ...
            return apply_filters( 'urus_cached_widget_id', $widget_id_for_cache );
        }
    }
}