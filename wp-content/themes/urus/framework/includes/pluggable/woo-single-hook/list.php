...
add_action('woocommerce_before_single_product_summary',array('Urus_Pluggable_WooCommerce','woocommerce_show_product_thumbnails'),20);
...
add_action( 'woocommerce_single_product_summary', array('Urus_Pluggable_WooCommerce','single_canvas_tabs_title'), 60 );
