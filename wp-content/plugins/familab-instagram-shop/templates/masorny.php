 ...
 *
 * Masorny style layout
 *
 * This template can be overridden by copying it to yourtheme/familab-instagram-shop/templates/masorny.php.
 * @var $pin_data_array
...
?>
 <div class="tis-image-items masorny-style" data-post-id="<?php echo esc_attr($id); ?>">
	<?php 
	$index = 0;
