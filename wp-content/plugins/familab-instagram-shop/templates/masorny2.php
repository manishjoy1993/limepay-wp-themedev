...
?>
 <div class="tis-image-items masorny-style2 row no-gutters" data-post-id="<?php echo esc_attr($id); ?>">
 	<div class="col-12 col-md-6 big-group tis-col-15">
	<?php 
	$index = 0;
