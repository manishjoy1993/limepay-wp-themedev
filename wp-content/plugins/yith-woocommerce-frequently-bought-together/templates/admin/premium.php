...
.section.one{
    background-image: url(<?php echo YITH_WFBT_ASSETS_URL?>/images/01-bg.png);
}
.section.two{
    background-image: url(<?php echo YITH_WFBT_ASSETS_URL?>/images/02-bg.png);
}
.section.three{
    background-image: url(<?php echo YITH_WFBT_ASSETS_URL?>/images/03-bg.png);
}
.section.four{
    background-image: url(<?php echo YITH_WFBT_ASSETS_URL?>/images/04-bg.png);
}
.section.five{
    background-image: url(<?php echo YITH_WFBT_ASSETS_URL?>/images/05-bg.png);
}
.section.six{
    background-image: url(<?php echo YITH_WFBT_ASSETS_URL?>/images/06-bg.png);
}
.section.seven{
    background-image: url(<?php echo YITH_WFBT_ASSETS_URL?>/images/07-bg.png);
}
.section.eight{
    background-image: url(<?php echo YITH_WFBT_ASSETS_URL?>/images/08-bg.png);
}
...
<div class="landing">
    ...
    <div class="eight section section-odd clear">
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    <img src="<?php echo YITH_WFBT_ASSETS_URL?>/images/08-icon.png" alt="icon 08" />
                    <h2><?php _e('SET DISCOUNT FOR FREQUENTLY BOUGHT TOGETHER GROUP','yith-woocommerce-frequently-bought-together');?></h2>
                </div>
                <p>
                    <?php echo sprintf( __('You can either choose to apply a percentage discount or a fixed amount. The discount will be shown highlighted in the frequently bought together box. The discount will only be applied if the required number of products are selected.' ),'<b>','</b>','<br>' ) ?>
                </p>
            </div>
            <div class="col-1">
                <img src="<?php echo YITH_WFBT_ASSETS_URL?>/images/08.png" alt="Discount on frequently bought" />
            </div>
        </div>
    </div>
    <div class="section section-cta section-odd">
